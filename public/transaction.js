...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-sweetalert2'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  methods: {
    getProduct: function getProduct() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('/api/product/${this.product.id}').then(function (response) {
    ...
    addToCart: function addToCart() {
      ...
      this.submitCart = true; //send data to server
...
module.exports = __webpack_require__(/*! /var/www/html/laravel/pos-laravel/resources/assets/js/transaction.js */"./resources/assets/js/transaction.js");
